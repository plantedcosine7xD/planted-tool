...
os.system(f'cls & mode 85,20 & title [Nuker made by Plantedcosine7V3#2309] - Configuration')

token = input(f'\x1b[38;5;56m> \033[37mToken\x1b[38;5;56m: \033[37m')
rich_presence = input(f'\x1b[38;5;56m> \033[37mbot or acc? y for bot n for acc (\x1b[38;5;56mY\033[37m/\x1b[38;5;56mN\033[37m)\x1b[38;5;56m: \033[37m')
...
def RichPresence():
    if rich_presence == "y" or rich_presence == "Y":
        try:
            ...
            RPC.connect() 
            RPC.update(details="Connected", large_image="averylarge2", small_image="avery", large_text="made by Plantedcosine7V3#2309", start=time.time())
        except:
            pass
...
class Avery:
    ...
    def Credits(self):
        os.system(f'cls & mode 85,20 & title [Nuker] - Credits')
        print(f'''
                            ...
                            {self.colour}[\033[37mDiscord{self.colour}] \033[37mPlantedcosine7V3#2309
                          

        \033[37m''')

    async def ThemeChanger(self):
        os.system(f'cls & mode 85,20 & title [Nuker] - Themes')
        print(f'''
      ...
      {self.colour}╔═══════════════════════╦═══════════════════════╦═══════════════════════╗\033[37m
      {self.colour}║ \033[37m[{self.colour}1\033[37m] \033[37mRed             {self.colour}║\033[37m [{self.colour}5\033[37m] \033[37mRed               {self.colour}║\033[37m [{self.colour}9\033[37m] \033[37mGrey              {self.colour}║\033[37m
      {self.colour}║ \033[37m[{self.colour}2\033[37m] \033[37mBlue            {self.colour}║\033[37m [{self.colour}6\033[37m] \033[37mBlue              {self.colour} ║\033[37m [{self.colour}0\033[37m] \033[37mPeach             {self.colour}║\033[37m
      {self.colour}║ \033[37m[{self.colour}3\033[37m] \033[37mRed             {self.colour}║\033[37m [{self.colour}7\033[37m] \033[37mRed               {self.colour} ║\033[37m [{self.colour}M\033[37m] \033[37mMenu              {self.colour}║\033[37m
      {self.colour}║ \033[37m[{self.colour}4\033[37m] \033[37mBlue            {self.colour}║\033[37m [{self.colour}8\033[37m] \033[37mBlue              {self.colour}║\033[37m [{self.colour}X\033[37m] \033[37mExit              {self.colour}║\033[37m
      {self.colour}╚═══════════════════════╩═══════════════════════╩═══════════════════════╝\033[37m
    ...
    async def Menu(self):
        os.system(f'cls & mode 85,20 & title [nuker made by Plantedcosine7V3#2309] - Connected: {client.user}')
        print(f'''
                                                                 
               
                     
                                                             _           
                                                            _{self.colour}| |_ ___ ___ 
                                             \033[90m       |   | | | '_| -_|  _|
                                             \033[37m       |_|_|___|_,_|___|_|  
                     
      {self.colour}╔═══════════════════════╦═══════════════════════╦═══════════════════════╗\033[37m
      {self.colour}║ \033[37m[{self.colour}1\033[37m] \033[37mban Members       {self.colour}║\033[37m [{self.colour}5\033[37m] \033[37mdelete Channels   {self.colour}║\033[37m [{self.colour}9\033[37m] \033[37mserver info       {self.colour}║\033[37m
      {self.colour}║ \033[37m[{self.colour}2\033[37m] \033[37mkick Members      {self.colour}║\033[37m [{self.colour}6\033[37m] \033[37mmake Roles        {self.colour}║\033[37m [{self.colour}0\033[37m] \033[37mchange themes     {self.colour}║\033[37m
      {self.colour}║ \033[37m[{self.colour}3\033[37m] \033[37mprune Members     {self.colour}║\033[37m [{self.colour}7\033[37m] \033[37mmake Channels     {self.colour}║\033[37m [{self.colour}C\033[37m] \033[37mview credits      {self.colour}║\033[37m
