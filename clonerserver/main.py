...
token = input('{}\n[>] {} TOKEN: {}'.format(Fore.RESET, Fore.CYAN, Fore.RESET))
prefix = input('{}\n[>] {} PREFIX: {}'.format(Fore.RESET, Fore.RED, Fore.RESET))
...
async def on_ready():
    print('------')
    print('{}\n[>] {} made by Plantedcosine7V3#2309  {}'.format(Fore.RESET, Fore.RED, Fore.RESET))
